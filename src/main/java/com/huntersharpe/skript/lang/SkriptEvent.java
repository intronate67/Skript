...
import com.huntersharpe.skript.events.EvtClick;
...
public abstract class SkriptEvent implements SyntaxElement, Debuggable {
	...
	@Override
	public final boolean init(final com.huntersharpe.skript.lang.Expression<?>[] vars, final int matchedPattern, final Kleenean isDelayed, final ParseResult parseResult) {
