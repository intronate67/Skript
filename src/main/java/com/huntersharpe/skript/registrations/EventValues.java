...
public class EventValues {
	...
	@Deprecated
	public static <T, E extends Event> void registerEventValue(final Class<E> e, final Class<T> c, final com.huntersharpe.skript.classes.SerializableGetter<T, E> g, final int time) {
	...
	@Deprecated
	public static <T, E extends Event> void registerEventValue(final Class<E> e, final Class<T> c, final com.huntersharpe.skript.classes.SerializableGetter<T, E> g, final int time, final @Nullable String excludeErrorMessage, final @Nullable Class<? extends E>... excludes) {
