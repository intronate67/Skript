...
package com.huntersharpe.skript.registrations;
...
import com.huntersharpe.skript.classes.ChainedConverter;
import com.huntersharpe.skript.classes.Converter;
import com.huntersharpe.skript.classes.Converter.ConverterInfo;
import com.huntersharpe.skript.classes.Converter.ConverterUtils;
...
public abstract class Converters {
	...
	@Deprecated
	public static <F, T> void registerConverter(final Class<F> from, final Class<T> to, final com.huntersharpe.skript.classes.SerializableConverter<F, T> converter) {
	...
	@Deprecated
	public static <F, T> void registerConverter(final Class<F> from, final Class<T> to, final com.huntersharpe.skript.classes.SerializableConverter<F, T> converter, final int options) {
